...
**Achtung:** Da Pappe leicht entflammbar ist, gilt diese Gehäusewahl ausschließlich für die hocheffiziente 6V-Version der Schaltung. Außerdem sollte die Gesamtlast auf maximal drei Sternchen mit LED-Licht (nicht Glühlampe) begrenzt bleiben.

Aufgrund des sehr geringen Stromverbrauchs erwärmt sich die Schaltung bei dieser Last kaum. Dennoch sind im Inneren Abstandshalter aus Kunststoff zwingend erforderlich, um direkten Kontakt zwischen der Leiterplatte und der Pappe zu vermeiden und die minimal entstehende Wärme abzuführen.
